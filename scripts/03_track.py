...
def run(args: argparse.Namespace) -> None:
    ...
    # load model and fuse layers for faster inference
    ...
    # init tracker, CMC compensator, and renderer
    tracker = ByteTracker(
    ...
    # handle ctrl+c gracefully - flush writer before dying
    interrupted = False
    def _sig(sig, frm):
    ...
    try:
        for frame_id, frame in src:
            ...
            # detector - single forward pass at 1280px, FP16
