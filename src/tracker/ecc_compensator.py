"""src/tracker/ecc_compensator.py — ECC-based camera motion compensator."""
import cv2
import numpy as np
...
class ECCCompensator:
    ...
    #ECC terminaation: stop after 10 iterations OR if improvement < 0.01
    ...
    def __init__(self, downscale_wh: tuple = (320,180)):
        ...
        # Identify warp (no motion) used as warm start and fallback
    ...
    def update(self, frame: np.ndarray) -> np.ndarray:
        ...
        if self.prev_gray is not None:
            ...
            # Scale translation from downscale -> full-frame coords
                ...
                #ECC diveged (eg, flat sky,rapid motion blur) - use identity
